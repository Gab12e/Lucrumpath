...
const Newsletter = () => {
  return <section className='py-[40px] lg:py-[88px] bg-newsletter bg-cover'>
    <div className='container mx-auto'>
      <div className='flex flex-col lg:flex-row items-center justify-center bg-blue p-12 rounded-2xl lg:bg-newsletterBox lg:bg-no-repeat lg:h-[126px] ' data-aos='fade-up' data-aos-offset='500'>
